...
/**
 * PSN with wait-based aging and boost-on-exit:
 * Decrease priority by 1 for any process that has waited in the queue for X+ time,
 * and increase priority (numerically lower) for a process when it leaves the CPU.
 */
public class PSNWaitAgingBoostOnExit
{
